        ...
        body: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                BuildGenreContainer(size: size, genre: "Naruto",),
                BuildGenreContainer(size: size, genre: "One Piece"), 
                BuildGenreContainer(size: size, genre: "Marvel"), 
                BuildGenreContainer(size: size, genre: "Bleach"),
                BuildGenreContainer(size: size, genre: "DBZ"),
                BuildGenreContainer(size: size, genre: "Harry Potter"),
              ],
            ),
          ),
        ));
